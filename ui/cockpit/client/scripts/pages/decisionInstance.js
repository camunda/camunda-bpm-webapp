...
var Controller = [
  '$scope', '$rootScope', '$q', 'dataDepend', 'page', 'camAPI', 'decisionInstance', 'Views', 'search', 'translateFilter',
  function($scope,   $rootScope,   $q,   dataDepend,   page,   camAPI,   decisionInstance,   Views,   search, translateFilter
  ) {
    ...
    page.titleSet([
      decisionInstance.id,
      translateFilter('DECISION_INSTANCE_INSTANCE_VIEW')
    ].join(' | '));
