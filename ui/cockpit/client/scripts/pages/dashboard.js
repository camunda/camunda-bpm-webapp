...
var Controller = [
  ...
  // ----------------------------------------------------------------------------------------
    ...
    function prepareValues(values, total, url) {
      ...
      var belowTreshold = {
        value: 0,
        label: translateFilter('DASHBOARD_OTHERS'),
        names: [],
        url: url
      };
              ...
              assignedToUser: function(done) {
                taskResource.count({
                  ...
                  assigned: true
                    ...
                    label: translateFilter('DASHBOARD_ASSIGNED_TO_USER'),
              ...
              assignedToGroup: function(done) {
                taskResource.count({
                  ...
                  withCandidateGroups: true
                    ...
                    label: translateFilter('DASHBOARD_ASSIGNED_TO_GROUPS'),
              ...
              unassigned: function(done) {
                taskResource.count({
                  ...
                  withoutCandidateGroups: true
                    ...
                    label: translateFilter('DASHBOARD_UNASSIGNED'),
