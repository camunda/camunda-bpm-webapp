...
var Controller = [
  ...
  'decisionDefinition', 'Views', 'search', 'isModuleAvailable', 'translateFilter',
  function($scope,   $rootScope,   $q,   dataDepend,   page,   camAPI,
    ...
    $scope.breadcrumbData = decisionData.observe([ 'decisionDefinition' ], function(definition) {
      ...
      page.breadcrumbsAdd([
        {
          label: translateFilter('DECISION_DEFINITION_DECISIONS'),
          href: '#/decisions'
        },
        {
      ...
      page.titleSet([
        ...
        translateFilter('DECISION_DEFINITION_DEFINITION_VIEW')
      ].join(' | '));
    });
