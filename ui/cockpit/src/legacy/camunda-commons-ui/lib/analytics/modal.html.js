...
<div class="analytics-body">
    ...
    <div class="content" ng-if="page === 2">
    ...
    <div class="content" ng-if="page === 3">
    ...
    <div class="content" ng-if="page === 4">
    ...
    <div class="footer" ng-if="page > 1 && page < 5">
