        ...
        $scope.headColumns = [
          {
            ...
            request: 'jobId',
            sortable: true,
            content: $translate.instant('PLUGIN_JOBS_ID')
          },
          {
            class: 'dueDate',
            request: 'jobDueDate',
            sortable: true,
            content: $translate.instant('PLUGIN_JOBS_DATE')
          },
          {
            class: 'createTime',
            request: 'createTime',
            sortable: false,
            content: $translate.instant('PLUGIN_JOBS_CREATION_DATE')
          },
          {
            class: 'retries',
            request: 'jobRetries',
            sortable: true,
            content: $translate.instant('PLUGIN_JOBS_RETRIES')
          },
          {
            class: 'activityName',
            request: 'activityName',
            sortable: false,
            content: $translate.instant('PLUGIN_JOBS_ACTIVITY')
          },
          {
            class: 'action',
            request: '',
            sortable: false,
            content: $translate.instant('PLUGIN_JOBS_ACTION')
          }
        ];
