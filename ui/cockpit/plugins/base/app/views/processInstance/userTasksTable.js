  ...
  ngModule.controller('UserTaskController', [
    ...
    function(
      ...
      $scope.headColumns = [
        {
          class: 'activity uuid',
          request: 'nameCaseInsensitive',
          sortable: true,
          content: $translate.instant('PLUGIN_USER_TASKS_ACTIVITY')
        },
        {
          class: 'assignee',
          request: 'assignee',
          sortable: true,
          content: $translate.instant('PLUGIN_USER_TASKS_ASSIGNEE')
        },
        {
          class: 'owner',
          request: '',
          sortable: false,
          content: $translate.instant('PLUGIN_USER_TASKS_OWNER')
        },
        {
          class: 'created',
          request: 'created',
          sortable: true,
          content: $translate.instant('PLUGIN_USER_TASKS_CREATED_DATE')
        },
        {
          class: 'due',
          request: 'dueDate',
          sortable: true,
          content: $translate.instant('PLUGIN_USER_TASKS_DUE_DATE')
        },
        {
          class: 'follow-up',
          request: 'followUpDate',
          sortable: true,
          content: $translate.instant('PLUGIN_USER_TASKS_FOLLOW_UP_DATE')
        },
        {
          class: 'priority',
          request: 'priority',
          sortable: true,
          content: $translate.instant('PLUGIN_USER_TASKS_PRIORITY')
        },
        {
          class: 'delegation-state',
          request: '',
          sortable: false,
          content: $translate.instant('PLUGIN_USER_TASKS_DELEGATION_STATE')
        },
        {
          class: 'task-id uuid',
          request: 'id',
          sortable: true,
          content: $translate.instant('PLUGIN_USER_TASKS_TASK_ID')
        },
        {
          class: 'action',
          request: '',
          sortable: false,
          content: $translate.instant('PLUGIN_USER_TASKS_ACTION')
        }
      ];
      ...
      function updateView(newFilter, executionIdToInstanceMap, sorting) {
        ...
        TaskResource.query(pagingParams, params).$promise.then(function(
          response
        ) {
