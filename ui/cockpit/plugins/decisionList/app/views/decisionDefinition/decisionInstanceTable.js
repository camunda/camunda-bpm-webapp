          ...
          $scope.headColumns = [
            {
              ...
              request: '',
              sortable: false,
              content: $translate.instant('PLUGIN_DECISION_ID')
            },
            {
              class: 'start-time',
              request: 'evaluationTime',
              sortable: true,
              content: $translate.instant('PLUGIN_DECISION_EVALUATION_TIME')
            },
            {
              ...
              content: $translate.instant(
                'PLUGIN_DECISION_CALLING_PROCESS_CASE'
              )
            },
            {
              class: 'instance-id',
              request: '',
              sortable: false,
              content: $translate.instant('PLUGIN_DECISION_CALLING_INSTANCE_ID')
            },
            {
              class: 'activity-id',
              request: '',
              sortable: false,
              content: $translate.instant('PLUGIN_DECISION_ACTIVITY_ID')
            }
          ];
