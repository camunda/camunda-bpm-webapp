        ...
        $scope.headColumns = [
          {
            ...
            request: 'name',
            sortable: true,
            content: $translate.instant('PLUGIN_DECISION_TABLE_NAME')
          },
          {
            class: 'tenant-id',
            request: 'tenantId',
            sortable: true,
            content: $translate.instant('PLUGIN_DECISION_TABLE_TENANT_ID')
          },
          {
            class: 'drd',
            request: 'drd.name',
            ...
            content: $translate.instant(
              'PLUGIN_DECISION_TABLE_DECISION_REQUIREMENTS'
            ),
            condition: $scope.isDrdAvailable
          }
        ];
